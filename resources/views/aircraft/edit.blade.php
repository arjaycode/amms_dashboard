              ...
              <form action="{{ route('aircraft.update', $aircraft->id) }}" method="POST">
                ...
                <div class="container d-flex flex-row gap-4">
                  ...
                  <div class="mb-3 col">
                    ...
                    <input type="text" name="model" id="model" class="form-control bg-white px-1" value="{{ old('model', $aircraft->model) }}" required>
                  </div>
                  {{-- Date of Manufacture --}}
                  <div class="mb-3 col">
                    <label for="date_of_manufacture" class="form-label">Date of Manufacture:</label>
                    <input type="date" name="date_of_manufacture" id="date_of_manufacture" class="form-control bg-white px-1" value="{{ old('date_of_manufacture', $aircraft->date_of_manufacture) }}" required>
                  </div>
                </div>
                <div class="container d-flex flex-row gap-4">
                  {{-- Manufacturer Select --}}
